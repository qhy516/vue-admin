<template>
  <el-dialog title="支付方式编辑" :visible="this.visible" width="40%" @close="cancle">
    <el-form :model="detail" :rules="rules" ref="ruleForm">
      ...
      <el-form-item prop="qrCodeUrl" label="收款二维码：" :label-width="formLabelWidth">
        ...
        <el-col :span="16">
          <el-input type="textarea" :rows="3" v-model="detail.qrCodeUrl" :disabled="this.disabled"></el-input>
        </el-col>
      </el-form-item>
    </el-form>
    ...
    save(vet) {
      this.$refs.ruleForm.validate(valid => {
        if (valid) {
          ...
          this.axios
            .post("/admin/aliWechatPay/modify", param)
            .then(data => {
              this.editing = false;
