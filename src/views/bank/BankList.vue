  ...
  <div>
    <el-card class="box-card">
      <el-row class="chaozuobut">
        <el-button type="primary" size="small" @click="bankAdd">新增</el-button>
        <el-button type="warning" size="small" @click="bankEdit">修改</el-button>
...
<script>
import Add from "./BankAdd.vue";
import Edit from "./BankEdit.vue";
