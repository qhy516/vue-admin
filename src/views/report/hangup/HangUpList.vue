  ...
  <div>
    ...
    <el-card>
      ...
      >
        ...
        <el-table-column prop="phone" label="用户账户" mini-width="160" align="center"></el-table-column>
        ...
        <el-table-column prop="name" label="股票名称" width="160" align="center"></el-table-column>
        <el-table-column prop="isMargin" label="融资/融券" width="140" align="center"></el-table-column>
        <el-table-column prop="price" label="挂单单价" width="160" align="center"></el-table-column>
        <el-table-column prop="count" label="挂单数量" width="140" align="center"></el-table-column>
        <el-table-column prop="amount" label="挂单总额" width="140" align="center"></el-table-column>
      </el-table>
...
export default {
  ...
  methods: {
    ...
    querySum() {
      this.axios
        .get("/admin/entrust/entrustListSum", {
          params: {
            searchKeys: this.search.searchKeys,
            cid: this.search.cid,
            startTime: this.search.startTime,
